...
const ShowsTab = (props) => {
  ...
  const getItem = (item) => {
    ...
    const datePosted = new Date(item.date).toLocaleString("default", {
      year: "numeric",
      month: "long",
      day: "numeric",
    });
    ...
    return (
      <TouchableOpacity
        ...
        onPress={() => {
          props.props.navigation.navigate("OpenShowDetails", {
            data: item,
            profileType: props.pType,
          });
        }}
      >
        <View style={{ padding: "3%", width: "100%" }}>
              ...
              <View style={{ flexDirection: "row", alignItems: "center" }}>
                ...
                <View style={{ alignSelf: "center" }}>
                  <Text style={styles.dateTextSmall}>
                    {item.typeNeeded} - {item.genreNeeded}
                  </Text>
                </View>
              </View>
            </View>
          ...
          <View>
            <Text style={styles.smallText}>Created on {datePosted}</Text>
          </View>
