...
const HighlightsTab = () => {
      ...
      [
        ...
        },
        {
          ...
          onPress: () => {
            ...
            const filteredData = shows.filter(
              (item) => item[0] != selectedItem
            );
  ...
  async function addShowVenue() {
    const accessToken = await getAccessToken();
    const localId = await AsyncStorage.getItem("localId");
    const value = await addNewShowVenue(
      startTime,
      endTime,
      date,
      performersNeeded,
          ...
          <FlatList
            ...
            ListFooterComponent={() => {
              if (shows.length <= 5) {
                ...
                return (
                  <View style={{ alignItems: "center", marginBottom: "5%", paddingBottom: 300 }}>
                    <Text
                      style={{
                        fontSize: 14,
                        fontFamily: "Rubik-Regular",
            ...
            {profileCTX.basicInfo.profileType == "venue" && (
              <View>
                ...
                >
                  ...
                  <TouchableOpacity
                    onPress={() => {
                      setPerformersNeeded(!performersNeeded);
                    }}
                  >
                    {performersNeeded ? (
                      <Ionicons
