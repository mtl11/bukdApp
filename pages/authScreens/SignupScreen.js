...
const SignupScreen = (props) => {
  ...
  async function signUpHandler() {
    ...
    if (response) {
      ...
      const response = await addAccountFB(
        email,
        firstName,
        lastName,
        localId,
  ...
  async function signUpHandlerPerformer() {
    setIsAuth(true);
    let accountType;
    if (isPerformer == true) accountType = "performer";
    else accountType = "venue";
    const response = await submitVerifyRequest(
      performerEmail,
      profileName,
      firstName,
      lastName,
  ...
  function checkInputs() {
    ...
    if (!validatePasswordsLength()) {
      setEmailErrorMessage("Error: Passwords must be at least 8 charaters");
      return;
    }
        ...
        <SafeAreaView style={styles.container}>
          {addedAccount == true ? (
            <View style={{ marginTop: "10%", alignItems: "center" }}>
              ...
              >
                Thank you for Joining the Waitlist, We Will Verify Your Profile
                Shortly.
              </Text>
              <TouchableOpacity
                style={[
            ...
            <View>
              ...
              <KeyboardAwareScrollView>
                {!account && (
                  ...
                  >
                    <Text style={styles.bigText}>Choose an Account Type</Text>
                  </View>
                )}
                {!account && (
                  <View
                  ...
                  <View>
                    ...
                    >
                      <Text style={styles.bigText}>
                        Welcome,{" "}
                        <Text
                          style={{ color: global.color.secondaryColors.main }}
                        >
                          Live Music Fan
                        </Text>
                      </Text>
                    ...
                    <View style={styles.inputContainer}>
                      <TextInput
                        ...
                        placeholderTextColor={
                          global.color.secondaryColors.placeHolderTextColor
                        }
                        autoCorrect={false}
                        returnKeyType={"next"}
                ...
                {performerAccount && (
                  <View>
                    ...
                    <View style={styles.passwordInfoContainer}>
                      <Text style={styles.passwordInfoText}>Account Type</Text>
                    </View>
                    <View
                      style={{
                        flexDirection: "row",
                      ...
                      <View
                        style={[
                          styles.inputContainer,
                          {
                            ...
                            backgroundColor:
                              isPerformer == true
                                ? global.color.secondaryColors.main
                                : global.color.secondaryColors.adjacent,
                          },
                        ]}
                      >
                        <TouchableOpacity
                        ...
                        >
                          <Text
                            style={[
                              styles.input,
                              {
                                color: isPerformer == true ? "white" : "black",
                              },
                            ]}
                          >
                            Performer
                      ...
                      >
                        ...
                        >
                          <Text
                            style={[
                              styles.input,
                              { color: isVenue == true ? "white" : "black" },
                            ]}
                          >
                            Venue
                          </Text>
